...
"""
class Node:
    def __init__(self, node_id, flowtbl_capacity, flowtbl_used = 0):
...
"""
class Link:
    def __init__(self, link_id, src, dst, 
...
"""
class Flow:
    def __init__(self, flow_id, src, dst, rate=0, path_list=[],cur_path_id=0, inst_nodes=set()):
