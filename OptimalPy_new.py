...
class Para_new():
    def __init__(self,total_path_num,flow_num,link_num,node_num,p_l,p_n,LB,TB,OL,
        flow_pathcandidate,flow_path, no_loop_para,flow_flowcandidate_path,candidate_flow_num):
        self.total_path_num = total_path_num
        self.flow_num = flow_num
        self.link_num = link_num
        self.node_num = node_num
        self.candidate_flow_num = candidate_flow_num
...
class Optimal_new(Para_new):
    def __init__(self,total_path_num,flow_num,link_num,node_num,p_l,p_n,LB,TB,OL,
        flow_pathcandidate,flow_path, no_loop_para,flow_flowcandidate_path):
        self.name = "Optimal"
    ...
    def get_network_state(self,old_y,flow_rate,link_cap,node_table,critical_list_flow_relationship):
    ...
    def get_variables(self,model):
        ...
        y = model.addVars(self.flow_num, self.candidate_flow_num,
    ...
    def math_solution(self):
        ...
        # critical flow: m, candidate flows for a critical flow: k, path: i, link: l, node: n, 
            model.addConstrs((quicksum(y[m,k,i] * self.flow_flowcandidate_path[m][k][i]
                for i in self.flow_path[k]
                for k in self.candidate_flow_num) == 1 
            ...
            model.addConstrs((quicksum(y[m,k,i] * self.p_l[i][l]  * self.flow_rate[m] 
                ...
                for k in self.candidate_flow_num
            ...
            model.setObjective(r  + self.no_loop_para * quicksum(y[m,k,i] 
